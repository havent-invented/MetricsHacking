...
save_filename = "vimeo11k_BRISQ_2000mse_enhance_cheng2020_attn_quality2"
...
class Custom_enh_Loss(nn.Module):
    ...
    def forward(self, X_out, Y):
        ...
        self.loss["loss"] = self.loss["BRISQ"] + 2000*self.loss["mse_loss"] #+ loss["DISTS"] +  loss['MDTVSFA'] #+ loss["bpp_loss"] + lmbda / 2 * loss["mse_loss"] * 255 ** 2# * loss["mse"] + loss["bpp_loss"]
